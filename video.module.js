...
const frame_extractor_service_1 = require("./frame-extractor/frame-extractor.service");
...
exports.VideoModule = VideoModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [video_service_1.VideoService, frame_extractor_service_1.FrameExtractorService],
    })
], VideoModule);
